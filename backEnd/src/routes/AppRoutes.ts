...
import { listCustomer, searchCustomer, updateCustomer, bannedCustomer, detailCustomer } from "../controllers/CustomerController";
import { addBanner, deleteBanner, detailBanner, listBanner, updateBanner } from "../controllers/BannerController";
import { listEvent, addEvent, detailEvent, updateEvent, deleteEvent, eventByUser } from "../controllers/EventController";
import { listNews, addNews, detailNews, updateNews, deleteNews, newsByUser } from "../controllers/NewsController";
import { listCustomerFollow, listUserFollow, follow, unfollow } from "../controllers/FollowController";
import { listLocation, addLocation, deleteLocation, listLocationById } from "../controllers/LocationController";
import { listUserSchedule , listCustomerSchedule, bookSchedule, updateSchedule, deleteSchedule } from "../controllers/ScheduleController";
